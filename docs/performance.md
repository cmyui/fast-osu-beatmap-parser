...
uses their best measured pieces plus storage-lifetime fixes. All four preserve
the baseline's complete output on this corpus. Release `33aa2c0` predates
