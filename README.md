...
|---|---|---:|
| FOSU C++ AVX2 | Full supported document | 45.8 |
| FOSU C++ scalar | Full supported document | 91.4 |
...
FOSU rows were refreshed on 2026-09-18. Competitor rows retain the 2026-09-12
measurements from the same host, corpus and scheduling harness.
...
|---|---:|---:|---:|---:|
| Decode | 17.1 | 201.1 | 18.3 | 150.3 |
| Gameplay | 21.3 | 252.4 | 20.5 | 186.2 |
