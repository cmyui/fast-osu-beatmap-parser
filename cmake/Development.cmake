...
if(BUILD_TESTING)
  ...
  foreach(name IN LISTS _tests)
    ...
    target_include_directories(test_${name} PRIVATE ${PROJECT_SOURCE_DIR})
    target_compile_options(test_${name} PRIVATE $<IF:$<CXX_COMPILER_ID:MSVC>,/UNDEBUG,-UNDEBUG>)
  ...
  target_compile_options(test_dispatch PRIVATE $<IF:$<CXX_COMPILER_ID:MSVC>,/UNDEBUG,-UNDEBUG>)
  ...
  if(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
    ...
    target_include_directories(fuzz_parser PRIVATE ${PROJECT_SOURCE_DIR})
...
target_include_directories(reference_native PRIVATE ${PROJECT_SOURCE_DIR})
target_compile_options(reference_native PRIVATE $<IF:$<CXX_COMPILER_ID:MSVC>,/UNDEBUG,-UNDEBUG>)
...
target_include_directories(numeric_oracle PRIVATE ${PROJECT_SOURCE_DIR})
target_compile_definitions(numeric_oracle PRIVATE FOSU_DISABLE_SIMD)
fosu_profile(numeric_oracle)
target_compile_options(numeric_oracle PRIVATE $<IF:$<CXX_COMPILER_ID:MSVC>,/UNDEBUG,-UNDEBUG>)
...
target_include_directories(validate_corpus PRIVATE ${PROJECT_SOURCE_DIR})
target_compile_options(validate_corpus PRIVATE $<IF:$<CXX_COMPILER_ID:MSVC>,/UNDEBUG,-UNDEBUG>)
...
foreach(name library_compare feature_matrix profile_parse generate_corpus)
...
if(FOSU_ARENA_TELEMETRY)
  target_compile_definitions(profile_parse PRIVATE FOSU_ARENA_TELEMETRY)
  if(TARGET test_storage)
    target_compile_definitions(test_storage PRIVATE FOSU_ARENA_TELEMETRY)
  endif()
endif()
